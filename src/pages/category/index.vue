  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="right">
        <div class="title-img">
          <img
            src="https://img.alicdn.com/tfs/TB1ZkoLukCWBuNjy0FaXXXUlXXa-966-644.jpg_490x490q100.jpg_.webp"
            alt
          >
        </div>
        <div class="category-list" v-for="(item,index) in rightData" :key="index">
          <div class="category-list-title">
            ...
            <span class="title-name">{{item.cat_name}}</span>
            <span class="icon">/</span>
          </div>

          <div class="category-item" v-for="(setitem,setindex) in item.children" :key="setindex">
            <a :href="'/pages/searchlist/main?query='+setitem.cat_name" hover-class="none">
